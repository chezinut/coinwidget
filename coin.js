...
var CoinWidgetCom = {
	...
	, validate: function(config) {
		var $accepted = [];
		$accepted['currencies'] = ['bitcoin','litecoin','dash','ethereum', 'dogecoin'];
	...
	, show: function(obj) {
		...
		if (!$(coin_window).length) {
			...
			if ($config.qrcode) {
				$html += '<img class="COINWIDGETCOM_QRCODE" data-coinwidget-instance="'+$instance+'" src="'+CoinWidgetCom.source+'icon_qrcode.png" width="16" height="16"  alt="QR code icon"/>'
